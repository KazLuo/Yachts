<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Yacht.WebForm1" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Yatchassets/html/Scripts/jquery.min.js"></script>
    <script type="text/javascript" src="Yatchassets/html/Scripts/jquery.cycle.all.2.74.js"></script>
...
<![endif]-->
    <link href="Yatchassets/css/style.css" rel="stylesheet" type="text/css" />
    ...
    <form id="form1" runat="server">
        <div class="contain">
            ...
            <div class="bannermasks">
                <img src="Yatchassets/images/banner00_masks.png" alt="&quot;&quot;" /></div>
            <!--遮罩結束-->
...
<div class="banner">
<ul>
<li class="info on"><a href="#"><img src="Yatchassets/images/banner001b.jpg" /></a><!--文字開始--><div class="wordtitle">TAYANA <span>48</span><br /><p>SPECIFICATION SHEET</p></div><!--文字結束--></li>
<li class="info"><a href="#"><img src="Yatchassets/images/banner002b.jpg" /></a><!--文字開始--><div class="wordtitle">TAYANA <span>54</span><br /><p>SPECIFICATION SHEET</p></div><!--文字結束--><!--新船型開始  54型才出現其於隱藏 -->
<div class="new"><img src="images/new01.png" alt="new" /></div>
<!--新船型結束--></li>
<li class="info"><a href="#"><img src="Yatchassets/images/banner003b.jpg" /></a><!--文字開始--><div class="wordtitle">TAYANA <span>37</span><br /><p>SPECIFICATION SHEET</p></div><!--文字結束--></li>
<li class="info"><a href="#"><img src="Yatchassets/images/banner004b.jpg" /></a><!--文字開始--><div class="wordtitle">TAYANA <span>64</span><br /><p>SPECIFICATION SHEET</p></div><!--文字結束--></li>
<li class="info"><a href="#"><img src="Yatchassets/images/banner005b.jpg" /></a><!--文字開始--><div class="wordtitle">TAYANA <span>58</span><br /><p>SPECIFICATION SHEET</p></div><!--文字結束--></li>
<li class="info"><a href="#"><img src="Yatchassets/images/banner006b.jpg" /></a><!--文字開始--><div class="wordtitle">TAYANA <span>55</span><br /><p>SPECIFICATION SHEET</p></div><!--文字結束--></li>
</ul>
<!--小圖開始-->
<div class="bannerimg title">
<ul>
<li class="on"><div><p class="bannerimg_p"><img  src="images/i001.jpg" alt="&quot;&quot;" /></p></div></li>
<li><div><p class="bannerimg_p"><img  src="Yatchassets/images/i002.jpg" alt="&quot;&quot;" /></p></div></li>
<li><div><p class="bannerimg_p"><img  src="Yatchassets/images/i003.jpg" alt="&quot;&quot;" /></p></div></li>
<li><div><p class="bannerimg_p"><img  src="Yatchassets/images/i004.jpg" alt="&quot;&quot;" /></p></div></li>
<li><div><p class="bannerimg_p"><img  src="Yatchassets/images/i005.jpg" alt="&quot;&quot;" /></p></div></li>
<li><div><p class="bannerimg_p"><img  src="Yatchassets/images/i006.jpg" alt="&quot;&quot;" /></p></div></li>
</ul>
</div>
<!--小圖結束-->
</div> 
  ...
  <%--          <div class="news">
                <div class="newstitle">
                    <p class="newstitlep1">
                        <img src="Yatchassets/images/news.gif" alt="news" /></p>
                ...
                <ul>
                    ...
                    <li>
                        <div class="newstop">
                            <img src="Yatchassets/images/new_top01.png" alt="&quot;&quot;" /></div>
                        <div class="news01">
                            <div class="news02p1">
                                <p class="news02p1img">
                                    <img src="Yatchassets/images/pit002.jpg" alt="&quot;&quot;" /></p>
                            </div>
                            <p class="news02p2">
                    ...
                    <li>
                        <div class="news02">
                            <div class="news02p1">
                                <p class="news02p1img">
                                    <img src="Yatchassets/images/pit001.jpg" alt="&quot;&quot;" /></p>
                            </div>
                            <p class="news02p2">
             ...
             <div class="news">
                <div class="newstitle">
                    <p class="newstitlep1">
                        <img src="Yatchassets/images/news.gif" alt="news" />
                    </p>
                    <p class="newstitlep2">
            ...
            <div class="footer">
                ...
                <div class="footerp00">
                    <a href="#">
                        <img src="Yatchassets/images/tog.jpg" alt="&quot;&quot;" /></a>
