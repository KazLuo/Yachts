<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsContent.aspx.cs" Inherits="Yacht.WebForm3" %>
...
<!--遮罩-->
<div class="bannermasks"><img src="Yatchassets/images/banner02_masks.png" alt="&quot;&quot;" /></div>
<!--遮罩結束-->
...
<div class="banner">
<ul>
<li><img src="Yatchassets/images/newbanner.jpg" alt="Tayana Yachts" /></li>
</ul>
...
<!--------------------------------內容開始----------------------------------------------------> 
    <div class="box2_list">
                    <ul>
                        <asp:Literal ID="newContent" runat="server"></asp:Literal>
                    </ul>
